...
const ParagraphScreen = () => { 
    ...
    const paragraphHandler = async (e) => { 
        ...
        try {
            const { data } = await axios.post("https://forwardsetup.azurewebsites.net/api/openai/paragraph", {text});
            setParagraph(data);
        } catch (err) {
            console.log(err);
    ...
    return (
        ...
        >
            ...
            { paragraph ? 
                ...
                : 
                <Card sx={{mt:4, p:2, border: 1, boxShadow: 0, borderColor:"neutral.medium", borderRadius: 2, height: "500px", bgcolor: "background.default"}}>
                    <Typography variant="h3" color="neutral.main" sx={{textAlign: "center", verticalAlign: "middle", lineHeight: "450px"}}>Generated paragraph will appear here</Typography>
                </Card>
            }
