...
const ScifiScreen = () => { 
    ...
    const imageHandler = async (e) => { 
        ...
        try {
            const { data } = await axios.post("https://forwardsetup.azurewebsites.net/api/openai/scifi-img", {text});
            setImage(data);
        } catch (err) {
            console.log(err);
    ...
    return (
        ...
        >
            ...
            <form onSubmit={imageHandler}>
                <Typography variant="h3" mb={2}>Science Fiction Image Generator</Typography>
